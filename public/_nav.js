...
const RAIL=[
 ...
 {id:"build", href:"/build.html", icon:"build", label:"Build", children:[
   ...
   {id:"ideas",   href:"/ideas.html",        label:"The Idea Book"},
   {id:"styles",  href:"/styles.html",       label:"Style Systems"},
...
const ROOMS=[
 ...
 {p:"build",id:"styles",label:"Style Systems",href:"/styles.html",live:1,
  d:"24 systems and 35 sources. No page repeats its neighbour's style."},
 {p:"build",id:"ideas",label:"The Idea Book",href:"/ideas.html",live:1,
  d:"All 195 curated pieces: the mechanic, our version, the verse in full, and a verdict."},
