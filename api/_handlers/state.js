...
const OK = /^(comments\/p[0-4][0-9]\.jsonl|scores\.jsonl|versions\.jsonl|finals\.jsonl|feed\.jsonl|briefs\/p[0-4][0-9]\.md|spaces\/[a-z-]+\.md|inbox\.jsonl|well\.jsonl|well\/[a-z0-9-]+\.jsonl|reactions\.jsonl|statuses\.jsonl|constellations\.jsonl|personas\.jsonl|prospects\.jsonl|outreach\.jsonl|territories\.jsonl|messages\.jsonl|assignments\.jsonl|pagestatus\.jsonl)$/;
